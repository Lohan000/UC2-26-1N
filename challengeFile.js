...
function registerStudent(){
    let name = ask.question("Qual é o seu nome? ")
    let note1 = ask.question(`Sua primeira nota: `)
    let note2 = ask.question(`Sua segunda nota: `)
    let note3 = ask.question(`Sua terceira nota: `)
    register.push([name, note1, note2, note3])
}
